...
Api::getUpdates(std::int32_t offset, std::int32_t limit, std::int32_t timeout,
  ...
  return _tgTypeParser.parseJsonAndGetArray<Update>(
      &TgTypeParser::parseJsonAndGetUpdate, sendRequest("getUpdates", args));
}
...
Message::Ptr
Api::sendMessage(boost::variant<std::int64_t, std::string> chatId,
                 const std::string &text, bool disableWebPagePreview,
                 std::int32_t replyToMessageId, GenericReply::Ptr replyMarkup,
  ...
  if (!entities.empty()) {
    args.emplace_back("entities",
                      _tgTypeParser.parseArray<MessageEntity>(
                          &TgTypeParser::parseMessageEntity, entities));
  }
  ...
  if (replyMarkup) {
    args.emplace_back("reply_markup",
                      _tgTypeParser.parseGenericReply(replyMarkup));
  }
...
Api::forwardMessage(boost::variant<std::int64_t, std::string> chatId,
  ...
  return _tgTypeParser.parseJsonAndGetMessage(
...
Api::copyMessage(boost::variant<std::int64_t, std::string> chatId,
                 ...
                 bool disableNotification, std::int32_t replyToMessageId,
                 bool allowSendingWithoutReply, GenericReply::Ptr replyMarkup,
                 bool protectContent, std::int32_t messageThreadId) const {
  std::vector<HttpReqArg> args;
  args.reserve(12);
  ...
  if (!captionEntities.empty()) {
    args.emplace_back("caption_entities",
                      _tgTypeParser.parseArray<MessageEntity>(
...
Api::sendAudio(boost::variant<std::int64_t, std::string> chatId,
  ...
  if (thumb.which() == 0) { // InputFile::Ptr
    ...
    args.emplace_back("thumb", file->data, true, file->mimeType,
                      file->fileName);
  } else { // std::string
...
Message::Ptr
Api::sendDocument(boost::variant<std::int64_t, std::string> chatId,
...
Message::Ptr
Api::sendAnimation(boost::variant<std::int64_t, std::string> chatId,
                   boost::variant<InputFile::Ptr, std::string> animation,
                   std::int32_t duration, std::int32_t width,
                   std::int32_t height,
                   boost::variant<InputFile::Ptr, std::string> thumb,
                   const std::string &caption, std::int32_t replyToMessageId,
                   GenericReply::Ptr replyMarkup, const std::string &parseMode,
  ...
  return _tgTypeParser.parseJsonAndGetMessage(
      sendRequest("sendAnimation", args));
}
...
Message::Ptr
Api::sendVideoNote(boost::variant<std::int64_t, std::string> chatId,
                   boost::variant<InputFile::Ptr, std::string> videoNote,
                   std::int64_t replyToMessageId, bool disableNotification,
                   std::int32_t duration, std::int32_t length,
                   boost::variant<InputFile::Ptr, std::string> thumb,
                   GenericReply::Ptr replyMarkup, bool allowSendingWithoutReply,
                   bool protectContent, std::int32_t messageThreadId) const {
  std::vector<HttpReqArg> args;
  args.reserve(11);
  ...
  return _tgTypeParser.parseJsonAndGetMessage(
      sendRequest("sendVideoNote", args));
}

std::vector<Message::Ptr>
Api::sendMediaGroup(boost::variant<std::int64_t, std::string> chatId,
  ...
  args.emplace_back("media", _tgTypeParser.parseArray<InputMedia>(
                                 &TgTypeParser::parseInputMedia, media));
  if (disableNotification) {
    args.emplace_back("disable_notification", disableNotification);
  }
  if (protectContent) {
  ...
  return _tgTypeParser.parseJsonAndGetArray<Message>(
      &TgTypeParser::parseJsonAndGetMessage,
      sendRequest("sendMediaGroup", args));
}

Message::Ptr
Api::sendLocation(boost::variant<std::int64_t, std::string> chatId,
                  float latitude, float longitude, std::int32_t livePeriod,
                  std::int32_t replyToMessageId, GenericReply::Ptr replyMarkup,
...
Message::Ptr Api::editMessageLiveLocation(
  ...
  if (replyMarkup) {
    args.emplace_back("reply_markup",
                      _tgTypeParser.parseInlineKeyboardMarkup(replyMarkup));
  }

  return _tgTypeParser.parseJsonAndGetMessage(
      sendRequest("editMessageLiveLocation", args));
}
...
Api::stopMessageLiveLocation(boost::variant<std::int64_t, std::string> chatId,
  ...
  return _tgTypeParser.parseJsonAndGetMessage(
      sendRequest("stopMessageLiveLocation", args));
}
...
Message::Ptr Api::sendVenue(
    ...
    const std::string &googlePlaceType, bool allowSendingWithoutReply,
    bool protectContent, std::int32_t messageThreadId) const {
  std::vector<HttpReqArg> args;
  args.reserve(15);
...
Message::Ptr Api::sendPoll(
  ...
  args.emplace_back("options",
                    _tgTypeParser.parseArray<std::string>(
...
bool Api::sendChatAction(std::int64_t chatId, const std::string &action) const {
  std::vector<HttpReqArg> args;
  args.reserve(2);
...
UserProfilePhotos::Ptr Api::getUserProfilePhotos(std::int64_t userId,
  ...
  return _tgTypeParser.parseJsonAndGetUserProfilePhotos(
...
bool Api::restrictChatMember(boost::variant<std::int64_t, std::string> chatId,
  ...
  args.emplace_back("chat_id", chatId);
  args.emplace_back("user_id", userId);
  args.emplace_back("permissions",
                    _tgTypeParser.parseChatPermissions(permissions));
  if (untilDate) {
    args.emplace_back("until_date", untilDate);
  }
...
Api::createChatInviteLink(boost::variant<std::int64_t, std::string> chatId,
  ...
  return _tgTypeParser.parseJsonAndGetChatInviteLink(
      sendRequest("createChatInviteLink", args));
}
...
Api::editChatInviteLink(boost::variant<std::int64_t, std::string> chatId,
  ...
  return _tgTypeParser.parseJsonAndGetChatInviteLink(
      sendRequest("editChatInviteLink", args));
}
...
Api::revokeChatInviteLink(boost::variant<std::int64_t, std::string> chatId,
  ...
  return _tgTypeParser.parseJsonAndGetChatInviteLink(
      sendRequest("revokeChatInviteLink", args));
}
...
std::vector<ChatMember::Ptr> Api::getChatAdministrators(
  ...
  return _tgTypeParser.parseJsonAndGetArray<ChatMember>(
      &TgTypeParser::parseJsonAndGetChatMember,
      sendRequest("getChatAdministrators", args));
}
...
Api::getChatMember(boost::variant<std::int64_t, std::string> chatId,
  ...
  return _tgTypeParser.parseJsonAndGetChatMember(
...
std::vector<Sticker::Ptr> Api::getForumTopicIconStickers() const {
  return _tgTypeParser.parseJsonAndGetArray<Sticker>(
      &TgTypeParser::parseJsonAndGetSticker,
      sendRequest("getForumTopicIconStickers"));
}
...
Api::createForumTopic(boost::variant<std::int64_t, std::string> chatId,
  ...
  return _tgTypeParser.parseJsonAndGetForumTopic(
      sendRequest("createForumTopic", args));
}
...
bool Api::setMyCommands(const std::vector<BotCommand::Ptr> &commands,
  ...
  args.emplace_back("commands", _tgTypeParser.parseArray<BotCommand>(
                                    &TgTypeParser::parseBotCommand, commands));
  if (scope != nullptr) {
...
Api::getMyCommands(BotCommandScope::Ptr scope,
  ...
  return _tgTypeParser.parseJsonAndGetArray<BotCommand>(
      &TgTypeParser::parseJsonAndGetBotCommand,
      sendRequest("getMyCommands", args));
}
...
MenuButton::Ptr Api::getChatMenuButton(std::int64_t chatId) const {
  ...
  return _tgTypeParser.parseJsonAndGetMenuButton(
      sendRequest("getChatMenuButton", args));
}
...
bool Api::setMyDefaultAdministratorRights(ChatAdministratorRights::Ptr rights,
  ...
  if (rights != nullptr) {
    args.emplace_back("rights",
                      _tgTypeParser.parseChatAdministratorRights(rights));
  }
  if (forChannels) {
...
Api::getMyDefaultAdministratorRights(bool forChannels) const {
  ...
  return _tgTypeParser.parseJsonAndGetChatAdministratorRights(
      sendRequest("getMyDefaultAdministratorRights", args));
}

Message::Ptr
Api::editMessageText(const std::string &text,
                     boost::variant<std::int64_t, std::string> chatId,
...
Message::Ptr
Api::sendSticker(boost::variant<std::int64_t, std::string> chatId,
                 boost::variant<InputFile::Ptr, std::string> sticker,
                 std::int32_t replyToMessageId, GenericReply::Ptr replyMarkup,
                 bool disableNotification, bool allowSendingWithoutReply,
                 bool protectContent, std::int32_t messageThreadId) const {
  std::vector<HttpReqArg> args;
  args.reserve(8);
...
StickerSet::Ptr Api::getStickerSet(const std::string &name) const {
  ...
  return _tgTypeParser.parseJsonAndGetStickerSet(
      sendRequest("getStickerSet", args));
}
...
std::vector<Sticker::Ptr> Api::getCustomEmojiStickers(
  ...
  return _tgTypeParser.parseJsonAndGetArray<Sticker>(
      &TgTypeParser::parseJsonAndGetSticker,
      sendRequest("getCustomEmojiStickers", args));
}
...
File::Ptr Api::uploadStickerFile(std::int64_t userId,
  ...
  args.emplace_back("user_id", userId);
  args.emplace_back("png_sticker", pngSticker->data, true, pngSticker->mimeType,
                    pngSticker->fileName);

  return _tgTypeParser.parseJsonAndGetFile(
      sendRequest("uploadStickerFile", args));
}

bool Api::createNewStickerSet(
    std::int64_t userId, const std::string &name, const std::string &title,
    const std::string &emojis, MaskPosition::Ptr maskPosition,
    boost::variant<InputFile::Ptr, std::string> pngSticker,
    InputFile::Ptr tgsSticker, InputFile::Ptr webmSticker,
  ...
  if (pngSticker.which() == 0) { // InputFile::Ptr
    ...
    args.emplace_back("png_sticker", file->data, true, file->mimeType,
                      file->fileName);
  } else { // std::string
    args.emplace_back("png_sticker", boost::get<std::string>(pngSticker));
  }
  if (tgsSticker != nullptr) {
    args.emplace_back("tgs_sticker", tgsSticker->data, true,
                      tgsSticker->mimeType, tgsSticker->fileName);
  }
  if (webmSticker != nullptr) {
    args.emplace_back("webm_sticker", webmSticker->data, true,
                      webmSticker->mimeType, webmSticker->fileName);
  }
  ...
  if (maskPosition != nullptr) {
    args.emplace_back("mask_position",
                      _tgTypeParser.parseMaskPosition(maskPosition));
  }

  return sendRequest("createNewStickerSet", args).get<bool>("", false);
}

bool Api::addStickerToSet(
    std::int64_t userId, const std::string &name, const std::string &emojis,
    MaskPosition::Ptr maskPosition,
    boost::variant<InputFile::Ptr, std::string> pngSticker,
    InputFile::Ptr tgsSticker, InputFile::Ptr webmSticker) const {
  std::vector<HttpReqArg> args;
  args.reserve(7);
...
bool Api::setStickerSetThumb(
    const std::string &name, std::int64_t userId,
...
bool Api::answerInlineQuery(const std::string &inlineQueryId,
  ...
  args.emplace_back("results",
                    _tgTypeParser.parseArray<InlineQueryResult>(
                        &TgTypeParser::parseInlineQueryResult, results));
  if (cacheTime) {
    args.emplace_back("cache_time", cacheTime);
  }
  if (isPersonal) {
...
Api::answerWebAppQuery(const std::string &webAppQueryId,
  ...
  return _tgTypeParser.parseJsonAndGetSentWebAppMessage(
      sendRequest("answerWebAppQuery", args));
}
...
Message::Ptr Api::sendInvoice(
    ...
    bool sendEmailToProvider, bool isFlexible, std::int32_t replyToMessageId,
    GenericReply::Ptr replyMarkup, bool disableNotification,
    bool allowSendingWithoutReply, std::int32_t maxTipAmount,
    const std::vector<std::int32_t> &suggestedTipAmounts,
    const std::string &startParameter, bool protectContent,
    std::int32_t messageThreadId) const {
  std::vector<HttpReqArg> args;
  args.reserve(28);
  ...
  args.emplace_back("prices", _tgTypeParser.parseArray<LabeledPrice>(
                                  &TgTypeParser::parseLabeledPrice, prices));
  args.emplace_back("max_tip_amount", maxTipAmount);
  if (!suggestedTipAmounts.empty()) {
    args.emplace_back(
        "suggested_tip_amounts",
        _tgTypeParser.parseArray<std::int32_t>(
            [](const std::int32_t &option) -> std::int32_t { return option; },
            suggestedTipAmounts));
  }
...
bool Api::answerShippingQuery(
  ...
  if (!shippingOptions.empty()) {
    args.emplace_back("shipping_options",
                      _tgTypeParser.parseArray<ShippingOption>(
...
bool Api::setPassportDataErrors(
  ...
  args.emplace_back("user_id", userId);
  args.emplace_back("errors",
                    _tgTypeParser.parseArray<PassportElementError>(
...
Api::getGameHighScores(std::int64_t userId, std::int64_t chatId,
  ...
  return _tgTypeParser.parseJsonAndGetArray<GameHighScore>(
      &TgTypeParser::parseJsonAndGetGameHighScore,
      sendRequest("getGameHighScores", args));
}
...
Api::sendRequest(const std::string &method,
  ...
  while (needRepeat && countOfAttempt < 3) {
    try {
      serverResponse = _httpClient.makeRequest(url, args);
      needRepeat = false;
  ...
  if (!serverResponse.compare(0, 6, "<html>")) {
    throw TgException("tgbot-cpp library have got html page instead of json "
                      "response. Maybe you entered wrong bot token.");
  }
  if (serverResponse.empty()) {
    throw TgException("Server responce is empty!");
  }
  ...
  try {
    ...
    throw TgException("tgbot-cpp library can't parse json response. " +
                      std::string(e.what()));
  }
}
} // namespace TgBot
